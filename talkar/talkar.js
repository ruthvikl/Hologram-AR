...
const DEVELOPMENT_URL = 'https://admin.talkar.app';
const PRODUCTION_URL = 'https://admin.talkar.app';

// const DEVELOPMENT_API_URL = 'http://localhost:1337/experiences';
const DEVELOPMENT_API_URL = 'https://admin.talkar.app/experiences';
...
async function getExperienceData() {
  try {
    ...
    dsen = sen.data.data;
    console.log("dsen", dsen)
    console.log("res",`${apiUrl}/${dsen.scene_id}`)
...
function initialzeAFrameScene() {
  ...
  <a-scene id="talkar-scene" cursor="rayOrigin: mouse" raycaster="objects: #talkar-ground" inspector="https://cdn.jsdelivr.net/gh/aframevr/aframe-inspector@master/dist/aframe-inspector.min.js">
    ...
    <a-box id="talkar-ground" material="shader: flat; transparent: true; opacity: 0.4;" scale="20 0.001 20" position="0 -2 0" color="#bdbdbd" shadow="receive: true"></a-box>  
    </a-scene>
  `;
...
const talkarComponent = {
  init: function () {
    ...
    const videoDetails = Object.assign(data.assets,{"7":{"__component": "assets.video-asset", "uniqueName":"video-asset", "resolutionX": 540, "resolutionY": 960, "id":12, "file":{"alternativeText": "", "ext": ".mp4", "mime": "video/mp4", "url": dsen.primary_media.url}}})
    const assetsData = videoDetails;
    // data.assets[7].file.url = dsen.primary_media.url;
    // const assetsData = data.assets;
    
    console.log("=====poke", assetsData)
    // const elementDetails = Object.assign(data.elements,{"9":{"anchor":"bottomCenter", "delay": 0.1, "endAnimations":[], "greenScreen": true, "id":9, "parentUniqueName": "main-element", "properties":[{"0":{"id": 15, "type": "position", "x": -0.3, "y": -0.1, "z": 0.35},"1": {"id": 16, "type": "scale", "x": 1, "y": 1, "z": 1},"2": {"type": "rotation", "x": 0, "y": 0, "z": 0},"3": {"type": "color", "x": 255, "y": 255, "z": 255}, "4": {"type": "opacity", "x": 1, "y": 0, "z": 0}
  // }]}})
    // const elementsData = elementDetails;
    ...
    function hideInterface() {
      const userInterface = document.getElementById('interface-container');
      const userInterface1 = document.getElementById('interface-container1');
      userInterface.style.display = 'none';
      userInterface1.style.visibility = 'hidden';
    }
    ...
    function triggerStartAnimation() {
      ...
      for (i = 0; i < startAnimations.length; i++) {
    ...
    function triggerTimeEndAnimation() {
      ...
      for (i = 0; i < endTimeAnimations.length; i++) {
        ...
        if (e.asset) {
          if (e.asset.type === 'video') {
            ...
            e.asset.asset.addEventListener('ended', function () {
              ...
              for (i = 0; i < endVideoAnimations.length; i++) {
